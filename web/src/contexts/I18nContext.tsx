...
const translations: Translations = {
  ...
  landing_headline: { es: "Gestión de Asistencia para Orquestas", en: "Attendance Management for Ensembles" },
  landing_desc: {
    es: "Una plataforma web completa para administrar la asistencia de estudiantes, generar reportes y mantener registros actualizados de su orquesta.",
    en: "A complete web platform to manage student attendance, generate reports, and keep your ensemble records up to date.",
  },
