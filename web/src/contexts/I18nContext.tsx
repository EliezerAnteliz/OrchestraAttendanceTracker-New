...
const translations: Translations = {
  ...
  greeting_morning: { es: "Buenos días, {name}", en: "Good morning, {name}" },
  greeting_afternoon: { es: "Buenas tardes, {name}", en: "Good afternoon, {name}" },
  greeting_evening: { es: "Buenas noches, {name}", en: "Good evening, {name}" },
  ...
  n_students_selected: { es: "{n} seleccionados", en: "{n} selected" },
  ...
  status_present: { es: "Asistió", en: "Present" },
  status_excused: { es: "Falta justificada", en: "Excused absence" },
  status_unexcused: { es: "Falta injustificada", en: "Unexcused absence" },
