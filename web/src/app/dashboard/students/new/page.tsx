                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-3 py-2 border border-[#d0d4e4] rounded-md focus:outline-none focus:ring-2 focus:ring-[#0086c0] focus:border-[#0086c0] transition-all duration-200 bg-white hover:border-[#a1a6b8] text-[#323338] placeholder:text-gray-400"
